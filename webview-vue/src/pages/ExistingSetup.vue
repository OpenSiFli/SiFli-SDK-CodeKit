  ...
  <div class="min-h-screen bg-vscode-background text-vscode-foreground font-vscode p-8">
    <div class="max-w-2xl mx-auto">
      ...
      <div class="vscode-card rounded-lg p-6 space-y-6 animate-fade-in-scale">
        ...
        <ToolchainSourceSelector v-model="toolchainSource" />
        ...
        <div class="form-item">
          ...
          <div class="flex gap-2">
            ...
            />
            <BaseButton variant="secondary" @click="browseSdkPath"> 浏览 </BaseButton>
          </div>
          <!-- Validation Message -->
          <div
        ...
        <div class="form-item">
          ...
          <div class="flex gap-2">
            <input
              ...
              class="flex-1 bg-vscode-input-background text-vscode-input-foreground border border-vscode-input-border rounded px-3 py-2 focus:outline-none focus:border-vscode-focus-border"
            />
            <BaseButton variant="secondary" @click="browseToolsPath"> 浏览 </BaseButton>
          </div>
        </div>
        ...
        <div class="pt-4">
          ...
          >
            ...
            >
              ...
              <div v-if="installationLogs.length === 0" class="text-gray-500 italic">等待日志输出...</div>
            </div>
          </div>
          ...
          <div class="flex gap-3">
            ...
            <!-- Cancel Button -->
            <BaseButton v-if="isInstalling" variant="secondary" size="lg" @click="handleCancelInstall" class="px-6">
              取消
            </BaseButton>
          </div>
        </div>
