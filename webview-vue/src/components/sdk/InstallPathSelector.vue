  ...
  <div class="form-item animate-slide-in-up">
    ...
    <div class="flex items-center gap-2 mb-3">
      ...
      <div class="flex-1 relative">
        <!-- 输入框容器 -->
        <div
          class="flex border border-vscode-input-border rounded overflow-hidden bg-vscode-input-background focus-within:ring-2 focus-within:ring-vscode-focus-border focus-within:border-vscode-focus-border transition-all duration-200"
        >
          <!-- 左侧输入区域 -->
          <div class="flex-1">
            <input
